...
const Downloads = () => {
    ...
    return (
        <section id="download" className='section-gap scroll-mt-24 h-[450px] xs:h-[500px] cxs:h-[550px] md:h-[610px] cmd:h-[680px] lg:h-auto'>
            ...
            <div className={` w-full relative h-[330px] xs:h-[350px] cxs:h-[380px] cmd:h-[450px] lg:h-[570px] bg-[#121212] ${process.env.basePath == '' ? 'lg:bg-download-section-local' : 'lg:bg-download-section-production' } bg-no-repeat bg-right bg-cover 3xl:bg-contain  sm:bg-[length:80%_100%] md:bg-[length:80%_100%] lg:bg-[length:80%_100%] xl:bg-[length:75%_100%] 2xl:bg-[length:78%_100%]`}>
