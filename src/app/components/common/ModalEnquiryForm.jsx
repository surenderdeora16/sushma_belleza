                                                ...
                                                <div className='mt-5 flex flex-col gap-10 w-full h-full'>
                                                    ...
                                                    <div>
                                                        <ul className='flex flex-wrap gap-x-8 xs:gap-x-16 gap-y-3'>
                                                            <li className={`font-supera600 text-[17px] text-[#bc8b27] `}><Link href={`${process.env.basePath}#products`} onClick={() => handleClose()} className="w-full h-full">Products</Link></li>
                                                            <li className={`font-supera600 text-[17px] text-[#bc8b27] `}><Link href={`${process.env.basePath}/plans`} onClick={() => handleClose()} className="w-full h-full">Plans</Link></li>
                                                            <li className={`font-supera600 text-[17px] text-[#bc8b27] `}><Link href={`${process.env.basePath}/amenities`} onClick={() => handleClose()} className="w-full h-full">Amenities</Link></li>
                                                            <li className={`font-supera600 text-[17px] text-[#bc8b27] `}><Link href={`${process.env.basePath}/price`} onClick={() => handleClose()} className="w-full h-full">Price</Link></li>
                                                            <li className={`font-supera600 text-[17px] text-[#bc8b27] `}><Link href={`${process.env.basePath}/location`} onClick={() => handleClose()} className="w-full h-full">Location</Link></li>
                                                            <li className={`font-supera600 text-[17px] text-[#bc8b27] `}><Link href={`${process.env.basePath}/gallery`} onClick={() => handleClose()} className="w-full h-full">Gallery</Link></li>
                                                        </ul>
                                                    </div>
