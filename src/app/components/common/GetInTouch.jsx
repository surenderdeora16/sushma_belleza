                                ...
                                <div className='w-full'>
                                    <div className='w-[90%] md:w-[85%] h-full grid grid-cols-2 grid-flow-row mx-auto  gap-x-[15px] gap-y-3 mt-10'>
                                        <div className='col-span-2 lg:col-span-1'>
                                            ...
                                            <div className='mt-1.5 w-full h-[44px] bg-[#232323] border-[0.74px] border-[#F2F9FF] rounded-[6px]'>
                                        ...
                                        <div className='col-span-2 cmd:col-span-1'>
                                            ...
                                            <div className='mt-1.5 w-full h-[44px] bg-[#232323] border-[0.74px] border-[#F2F9FF] rounded-[6px] font-supera500 flex items-center px-5'>
                                        ...
                                        <div className='col-span-2 '>
                                            <div className='mt-1 pr-2 w-full h-[44px] bg-[#232323] border-[0.74px] border-[#F2F9FF] rounded-[6px]'>
                                        ...
                                        <div className='col-span-2 '>
                                            <div className='mt-1 py-1 pr-2 w-full bg-[#232323] border-[0.74px] border-[#F2F9FF] rounded-[6px]'>
