...
const CallToAction = ({ className }) => {
    ...
    return (
        <section className='section-gap w-full '>
            ...
            <div className='bg-[#8E6C1C] h-[50px] sm:h-[80px] cmd:h-[100px] flex justify-center items-center '>
